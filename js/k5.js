...
(function($){
	...
	AutoResizer.prototype = {
		...
		this.injectClone();
			...
			// TEXTAREA
			clone.width(el.width()).height(0).val(value).scrollTop(500000);
			...
			if ((scrollTop + config.extraSpace >= config.maxHeight)&&(config.maxHeight!=-1)) {
				el.css('overflowY', '');
		...
		counter : function(options) {
			...
			options = $.extend({}, defaults, options), methods = {
				...
				init : function($obj) {
                    ...
                    var objID = $obj.attr('id'), counterID = 'text-counters';
...
/**
 * jQuery Text counters plugin
 * Stanislav Khromov
 * http://khromov.wordpress.com
 */

(function( $ ) {
  $.fn.textcounters = function()
  {
        //console.log(this);
        //alert('fgsfd');
  };
